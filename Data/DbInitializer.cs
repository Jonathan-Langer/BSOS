...
namespace BSOS.Data
{
    public static class DBInitializer
    {
        public static void Initialize(BSOSContext context)
        {
            ...
            {
                new Comment{Title="Comment1",Body="stam",SentBy="Moshe",Posted=DateTime.Parse("09-09-2020"),IP="",ProductId=8},
                new Comment{Title="Comment2",Body="stam",SentBy="Dror",Posted=DateTime.Parse("09-09-2020"),IP="",ProductId=8},
                new Comment{Title="Comment3",Body="stam",SentBy="Dror",Posted=DateTime.Parse("09-09-2020"),IP="",ProductId=9 }
            };
